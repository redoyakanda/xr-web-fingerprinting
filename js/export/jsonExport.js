...
export function selectExport(record,type='complete') { const g=record.featureGroups||{}; switch(type){case'passive':return record.passiveSnapshot;case'traditional':return g.traditionalFingerprintFeatures||{};case'xr':return g.xrFeatures||{};case'accessibility-passive':return {accessibilityPreferenceFeatures:g.accessibilityPreferenceFeatures||{},accessibilityEnvironmentFeatures:g.accessibilityEnvironmentFeatures||{},accessibilityAPISurfaceFeatures:g.accessibilityAPISurfaceFeatures||{}};case'extension':return g.extensionArtifactFeatures||{};case'interaction':return g.interactionFeatures||{};case'feature-vector':return {featureGroups:g};default:return record;} }
